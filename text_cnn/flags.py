...
flags.DEFINE_integer("max_input_length", 16, "maximum input text length")
...
flags.DEFINE_string("filters_size", "2,3,4", "convolution layer filters size")
...
flags.DEFINE_float("l2_lambda", 0.01, "l2 regularization coefficient")
