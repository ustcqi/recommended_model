...
def add_arguments(parser):
  ...
  # network
  # NOTE(qichao) 
  parser.add_argument("--load_embedding", type=bool, default=False, help="init embedding with doc2vec")
  parser.add_argument("--doc2vec_emb", type=str, default="/tmp/s2s_data/doc2vec_emb", help="doc2vec embedding")
  parser.add_argument("--src_reverse", type=bool, default=True, help="reverse src sequence")
  parser.add_argument("--with_inference", type=bool, default=False, help="whether use inference")
  parser.add_argument("--with_output_layer", type=bool, default=False, help="if or not with projection")
  parser.add_argument("--hidden_state_file", type=str, default="/tmp/s2s_data/hidden_state", help="")
  parser.add_argument("--emb_trainable", type=bool, default=True, help="")
  parser.add_argument("--src_embed_size", type=int, default=64, help="")
  parser.add_argument("--tgt_embed_size", type=int, default=64, help="")
  # END(note)
  parser.add_argument("--loss_type", type=str, default="square_loss", help="loss function type.")
  parser.add_argument("--num_units", type=int, default=5, help="Network size.")
  ...
  # Sequence lengths
  parser.add_argument("--src_max_len", type=int, default=5,
                      help="Max length of src sequences during training.")
  parser.add_argument("--tgt_max_len", type=int, default=5,
...
def create_hparams(flags):
  ...
  return tf.contrib.training.HParams(
      ...
      # NOTE(qichao)
      load_embedding=flags.load_embedding,
      doc2vec_emb=flags.doc2vec_emb,
      with_output_layer=flags.with_output_layer,
      loss_type=flags.loss_type,
      with_inference=flags.with_inference,
      hidden_state_file=flags.hidden_state_file,
      emb_trainable=flags.emb_trainable,
      src_embed_size=flags.src_embed_size,
      tgt_embed_size=flags.tgt_embed_size,
      # END(note)
...
def run_main(flags, default_hparams, train_fn, inference_fn, target_session=""):
  ...
  # NOTE(qichao) drop the code of inference and eval
